...
class pricebenefititalians extends StatefulWidget {
  pricebenefititalians({
    Key? key,
  }) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _pricebenefititaliansState();
  }
}

class _pricebenefititaliansState extends State<pricebenefititalians> {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Column(
            children: [
              Text(
                'A Financial Benefit Tool\nto compare Italian Ryegrass cultivars. ',
