...
class chicorystockareacalculator extends StatefulWidget {
  chicorystockareacalculator({
    Key? key,
  ...
  State<StatefulWidget> createState() {
    return _chicorystockareacalculatorState();
  }
}

class _chicorystockareacalculatorState extends State<chicorystockareacalculator> {
