...
class maverickg2 extends StatefulWidget {
  maverickg2({
    Key? key,
  ...
  @override
  State<maverickg2> createState() {
    return _maverickg2State();
  }
}

class _maverickg2State extends State<maverickg2> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/short-long-rotation/maverick-gii');
                                },
                          ...
                          child: RichText(
                              ...
                              text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      text:
                                          '1-2+ years depending upon summer rainfall.',
                                    ),
                                  ])),
                        ),
                        SizedBox(height: 10),
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Supreme-Agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
