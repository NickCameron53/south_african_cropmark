...
class MaverickgoldScreen extends StatefulWidget {
  const MaverickgoldScreen({
    Key? key,
  ...
  @override
  State<MaverickgoldScreen> createState() => _MaverickgoldScreenState();
}

class _MaverickgoldScreenState extends State<MaverickgoldScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Maverick GII'),
                  const SizedBox(height: 10),
                  const Text(
                    'Good winter and spring yields and improved summer production and summer forage quality.',
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'A late heading diploid short rotation ryegrass with good winter and spring yields, improved summer production and summer forage quality, low aftermath heading.'),
                    ],
                  ),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Late +17 days'),
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Persistence', '1 - 2+ years depending upon summer rainfall'),
                  const SizedBox(height: 10),
