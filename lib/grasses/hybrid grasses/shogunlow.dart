...
class shogunlow extends StatefulWidget {
  shogunlow({
    Key? key,
  ...
  @override
  State<shogunlow> createState() {
    return _shogunlowState();
  }
}

class _shogunlowState extends State<shogunlow> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Provides good summer and autumn yields.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/grass-cultivars/hybrid-ryegrass/shogun-nea12.htm');
                                },
                        ...
                        // ==================   Nea endophyte information ============================================
                        if (selectedIndex1 == endophytetype.indexOf('Nea')) ...[
                          SizedBox(height: 10),
                          SizedBox(
                            width: double.infinity,
                            child: RichText(
                        ...
                        // ========= end of Nea endophyte ==================
                        // ==================   standard endophyte information ============================================
                        if (selectedIndex1 ==
                            endophytetype.indexOf('Nea12')) ...[
                          SizedBox(height: 10),
                          SizedBox(
                            width: double.infinity,
                            child: RichText(
