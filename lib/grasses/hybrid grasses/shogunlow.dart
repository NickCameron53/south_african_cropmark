...
class ShogunScreen extends StatefulWidget {
  const ShogunScreen({
    Key? key,
  ...
  @override
  State<ShogunScreen> createState() => _ShogunScreenState();
}

class _ShogunScreenState extends State<ShogunScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Shogun'),
                  const SizedBox(height: 10),
                  const Text(
                    'Provides good summer and autumn yields.',
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Medium to Late +13 days'),
                  const SizedBox(height: 10),
