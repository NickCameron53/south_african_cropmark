...
class forgenea extends StatefulWidget {
  forgenea({
    Key? key,
  ...
  @override
  State<forgenea> createState() {
    return _forgeneaState();
  }
}

class _forgeneaState extends State<forgenea> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Provides good cool season production.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/grass-cultivars/hybrid-ryegrass/forge-2.htm');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.barenbrug.co.nz/misc/specific/productPdf.aspx?productID=148127&siteID=82');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
