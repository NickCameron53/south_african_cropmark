...
class frenzylow extends StatefulWidget {
  frenzylow({
    Key? key,
  ...
  @override
  State<frenzylow> createState() {
    return _frenzylowState();
  }
}

class _frenzylowState extends State<frenzylow> {
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.cropmarkseeds.com/wp-content/uploads/2024/06/Frenzy_TS-1.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
