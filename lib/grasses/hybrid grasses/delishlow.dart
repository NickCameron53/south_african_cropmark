...
class DelishScreen extends StatefulWidget {
  const DelishScreen({
    Key? key,
  ...
  @override
  State<DelishScreen> createState() => _DelishScreenState();
}

class _DelishScreenState extends State<DelishScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Delish'),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Medium +9 days'),
                  const SizedBox(height: 10),
