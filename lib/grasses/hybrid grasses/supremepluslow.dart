...
class SupremeplusScreenScreen extends StatefulWidget {
  const SupremeplusScreenScreen({
    Key? key,
  ...
  @override
  State<SupremeplusScreenScreen> createState() => _SupremeplusScreenScreenState();
}

class _SupremeplusScreenScreenState extends State<SupremeplusScreenScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Supreme Plus'),
                  const SizedBox(height: 10),
                  const Text(
                    'Has high tiller density',
