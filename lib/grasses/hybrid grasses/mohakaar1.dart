...
class MohakaScreen extends StatefulWidget {
  const MohakaScreen({
    Key? key,
  ...
  @override
  State<MohakaScreen> createState() => _MohakaScreenState();
}

class _MohakaScreenState extends State<MohakaScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Mohaka'),
