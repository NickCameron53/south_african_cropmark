...
class mohakaar1 extends StatefulWidget {
  mohakaar1({
    Key? key,
  ...
  @override
  State<mohakaar1> createState() {
    return _mohakaar1State();
  }
}

class _mohakaar1State extends State<mohakaar1> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A broader leaved, well tillered hybrid suited to 2-4 year pastures.',
                            style:
                        ...
                        Text(
                            ...
                            "\n\u25BA Mohaka is a broad leaved, well tillered hybrid suited to 2-4 year pastures.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/ryegrass/hybrid/mohaka');
                                },
