...
class PalliserScreen extends StatefulWidget {
  const PalliserScreen({
    Key? key,
  ...
  @override
  State<PalliserScreen> createState() => _PalliserScreenState();
}

class _PalliserScreenState extends State<PalliserScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Palliser'),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Very Late +25 days'),
                  const SizedBox(height: 10),
