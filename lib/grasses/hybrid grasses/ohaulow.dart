...
class OhauScreen extends StatefulWidget {
  const OhauScreen({
    Key? key,
  ...
  @override
  State<OhauScreen> createState() => _OhauScreenState();
}

class _OhauScreenState extends State<OhauScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Ohau'),
                  const SizedBox(height: 10),
                  const Text(
                    'Good winter and early spring growth.',
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'A long rotation tetraploid with good winter and early spring growth.'),
                      GlobalWidgets.buildBulletPoint(
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Medium +8 days'),
                  const SizedBox(height: 10),
