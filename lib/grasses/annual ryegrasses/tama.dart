...
class tama extends StatefulWidget {
  tama({
    Key? key,
  ...
  @override
  State<tama> createState() {
    return _tamaState();
  }
}

class _tamaState extends State<tama> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA An older public tetraploid Westerwolds cultivar."
                            "\n\u25BA Will not tolerate summer dry conditions."
                            "\n\u25BA Superseded by newer cultivars for yield.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://luisettiseeds.co.nz/product/tama-annual-ryegrass/');
                                },
