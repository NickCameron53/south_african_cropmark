...
class HoganScreen extends StatefulWidget {
  const HoganScreen({
    Key? key,
  ...
  @override
  State<HoganScreen> createState() => _HoganScreenState();
}

class _HoganScreenState extends State<HoganScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Hogan'),
