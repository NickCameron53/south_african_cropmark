                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA A cultivar with very quick establishment, good winter and spring yields, and feed high quality over a six to eight month growth period.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/sheep-beef-deer/cultivars/grass/italian-annual-ryegrass/hogan.htm');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.barenbrug.co.nz/misc/specific/productPdf.aspx?productID=118293&siteID=82');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
