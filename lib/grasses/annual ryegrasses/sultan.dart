...
class sultan extends StatefulWidget {
  sultan({
    Key? key,
  ...
  @override
  State<sultan> createState() {
    return _sultanState();
  }
}

class _sultanState extends State<sultan> {
                      ...
                      children: [
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL('https://ragt.nz/product/sultan/');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://ragt.nz/wp-content/uploads/2017/03/Sultan-annual-ryegrass_product-sheet.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
