...
class haymaker extends StatefulWidget {
  haymaker({
    Key? key,
  ...
  @override
  State<haymaker> createState() {
    return _haymakerState();
  }
}

class _haymakerState extends State<haymaker> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Haymaker is a warm season C4 annual grass which makes great quality hay and silage across several cuts throughout the warmest seasons of the year.',
                            style:
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(text: "\u25BA A specialist summer-active C4 annual grass suited to hay or silage production for farmers in warmer regions without frosts."
                                "\n\u25BA Also known as Teff ("),
                            TextSpan(text: "Eragrostis tef", style: TextStyle(fontStyle: FontStyle.italic)),
                            TextSpan(text: "), it is intermediate between a tropical and temperate grass with fine stems and many tillers."
                                "\n\u25BA It excels with a short maturity timeframe ensuring multiple high-quality cuts for hay and silage."
                                "\n\u25BA Resistant to damaging insect pests it guarantees a robust yield."
                                "\n\u25BA Elevated protein levels relative to other C4 grasses such as sorghum enhance livestock performance, high water use efficiency enhances environmental sustainability."
                                "\n\u25BA With lower risk of prussic acid compounds, quick establishment and suitability for late-season sowing, Haymaker is an ideal annual to plant for hay or silage production."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.cropmarkseeds.com/forage-seeds/haymaker/');
                                },
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Haymaker can be used as a specialist silage or hay crop in regions where there is no risk of frosts.'
                                '\nQuick to establish to the first cut as well as short intervals to subsequent cuts, four or more cuts can usually be achieved in a season.'
                                '\nHaymaker is perfect for sowing late in the season following crop failures or for late plantings',
                          ...
                          child: RichText(
                              ...
                              text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      text:
                                      '5 to 7 months subject to climate, insect pressure and management.',
                                    ),
                                  ])),
                        ),
                        SizedBox(height: 10),
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.cropmarkseeds.com/wp-content/uploads/2024/06/Haymaker_TS-1.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
