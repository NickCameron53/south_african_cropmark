...
class MaxsynScreen extends StatefulWidget {
  const MaxsynScreen({
    Key? key,
  ...
  @override
  State<MaxsynScreen> createState() => _MaxsynScreenState();
}

class _MaxsynScreenState extends State<MaxsynScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Maxsyn'),
                  const SizedBox(height: 10),
                  const Text(
                    'Strong summer and autumn growth.',
