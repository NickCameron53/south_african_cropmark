...
class MoxieScreen extends StatefulWidget {
  const MoxieScreen({
    Key? key,
  ...
  @override
  State<MoxieScreen> createState() => _MoxieScreenState();
}

class _MoxieScreenState extends State<MoxieScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Moxie\u2122'),
