...
class moxienil extends StatefulWidget {
  moxienil({
    Key? key,
  ...
  @override
  State<moxienil> createState() {
    return _moxienilState();
  }
}

class _moxienilState extends State<moxienil> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Semi upright growth & high tiller density.',
                            style:
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Semi upright growth & high tiller density."
                            "\n\u25BA Fits well into systems requiring a highly productive perennial ryegrass.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL('https://ragt.nz/product/moxie/');
                                },
