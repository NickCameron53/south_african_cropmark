...
class reasonar1 extends StatefulWidget {
  reasonar1({
    Key? key,
  ...
  @override
  State<reasonar1> createState() {
    return _reasonar1State();
  }
}

class _reasonar1State extends State<reasonar1> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Bred from plants screened in Northland, Waikato, Manawatu and Canterbury. Reason is ideal for sheep, beef and dairy systems looking for extra spring growth, while maintaining summer and autumn quality and production.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/ryegrass/perennial/reason');
                                },
