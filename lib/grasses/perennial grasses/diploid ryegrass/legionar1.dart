...
class LegionScreen extends StatefulWidget {
  const LegionScreen({
    Key? key,
  ...
  @override
  State<LegionScreen> createState() => _LegionScreenState();
}

class _LegionScreenState extends State<LegionScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Legion'),
                  ...
                  GlobalWidgets.buildInfoRow(
                      'Heading date', 'Medium to Late +13 days'),
                  const SizedBox(height: 10),
