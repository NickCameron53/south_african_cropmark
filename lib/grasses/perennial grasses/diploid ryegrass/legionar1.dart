...
class legionar1 extends StatefulWidget {
  legionar1({
    Key? key,
  ...
  @override
  State<legionar1> createState() {
    return _legionar1State();
  }
}

class _legionar1State extends State<legionar1> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Bred from perennial ryegrass plants that were individually screened for persistence.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/ryegrass/perennial/legion');
                                },
