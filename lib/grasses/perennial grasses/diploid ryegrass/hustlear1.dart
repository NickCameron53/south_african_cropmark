...
class hustlear1 extends StatefulWidget {
  hustlear1({
    Key? key,
  ...
  @override
  State<hustlear1> createState() {
    return _hustlear1State();
  }
}

class _hustlear1State extends State<hustlear1> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Hustle\u2122 was bred for New Zealand systems, with broad disease tolerance, and performs well in a range of environments with exceptional cool season performance. Upright growth habit ensures compatibility with other species in the sward.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL('https://ragt.nz/product/hustle/');
                                },
