...
class arraynea2 extends StatefulWidget {
  arraynea2({
    Key? key,
  ...
  @override
  State<arraynea2> createState() {
    return _arraynea2State();
  }
}

class _arraynea2State extends State<arraynea2> {
  List<String> endophytetype = [
    'Nea2',
    // add this for other endophytes:
    // eg    'AR37',
  ];
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\n\u25BA Array has shown higher yields than 5 other cultivars in trials when grown in lower nitrogen soil conditions.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/grass-cultivars/perennial-ryegrass/array-nea2.htm');
                                },
