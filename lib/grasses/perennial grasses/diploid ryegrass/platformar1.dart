...
class platformar1 extends StatefulWidget {
  platformar1({
    Key? key,
  ...
  @override
  State<platformar1> createState() {
    return _platformar1State();
  }
}

class _platformar1State extends State<platformar1> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Production from this densely tillered variety is best achieved under rotational grazing."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/perennial/platform');
                                },
