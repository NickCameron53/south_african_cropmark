...
class GovernorScreen extends StatefulWidget {
  const GovernorScreen({
    Key? key,
  ...
  @override
  State<GovernorScreen> createState() => _GovernorScreenState();
}

class _GovernorScreenState extends State<GovernorScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Governor'),
                  const SizedBox(height: 10),
                  const Text(
                    'Fine leafed & densely tillered.',
