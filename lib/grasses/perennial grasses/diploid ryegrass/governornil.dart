...
class governornil extends StatefulWidget {
  governornil({
    Key? key,
  ...
  @override
  State<governornil> createState() {
    return _governornilState();
  }
}

class _governornilState extends State<governornil> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Fine leafed & densely tillered.',
                            style:
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA A Bronsyn & Tolosa cross for persistence, higher yields & palatability."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/grass-cultivars/perennial-ryegrass/governor.htm');
                                },
                            ...
                            child: RichText(
                                ...
                                text: TextSpan(
                                    ...
                                    children: [
                                      ...
                                      TextSpan(
                                        text:
                                            '\nProduces epoxy janthitrem. This selection may not meet the previous critieria you selected.',
                                      ),
                                    ])),
                          ),
                          SizedBox(height: 20),
