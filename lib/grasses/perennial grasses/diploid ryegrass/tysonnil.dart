...
class TysonScreen extends StatefulWidget {
  const TysonScreen({
    Key? key,
  ...
  @override
  State<TysonScreen> createState() => _TysonScreenState();
}

class _TysonScreenState extends State<TysonScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Tyson'),
                  ...
                  GlobalWidgets.buildInfoRow(
                      'Heading date', 'Very Early -10 days'),
                  const SizedBox(height: 10),
