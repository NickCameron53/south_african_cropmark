...
class tysonnil extends StatefulWidget {
  tysonnil({
    Key? key,
  ...
  @override
  State<tysonnil> createState() {
    return _tysonnilState();
  }
}

class _tysonnilState extends State<tysonnil> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Fit for sheep & beef operations.',
                            style:
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Very early heading variety with early spring growth."
                            "\n\u25BA Fit for sheep & beef operations.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/sheep-beef-deer/cultivars/grass/perennial-ryegrass/tyson.htm');
                                },
