...
class prospectar1 extends StatefulWidget {
  prospectar1({
    Key? key,
  ...
  @override
  State<prospectar1> createState() {
    return _prospectar1State();
  }
}

class _prospectar1State extends State<prospectar1> {
                    ...
                    child: Column(
                      children: [
                        SizedBox(
                          ...
                          child: Text('Grasslands Prospect',
                        ...
                        Text(
                            "\u25BA A dense fine leaved cultivar offering reliable all year-round production."
                            "\n\u25BA Certified as Lolium boucheanum due to tip awns but performs as a Lolium perenne.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Prospect-Agrinote.pdf');
                                },
