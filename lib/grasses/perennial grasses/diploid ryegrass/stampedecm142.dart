...
class stampedecm142 extends StatefulWidget {
  stampedecm142({
    Key? key,
  ...
  @override
  State<stampedecm142> createState() {
    return _stampedecm142State();
  }
}

class _stampedecm142State extends State<stampedecm142> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Late heading with a high leaf : stem ratio.',
                            style:
                                    ...
                                    children: [
                                      TextSpan(
                                          ...
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold)),
                                      TextSpan(
                                        text: 'Unlikely to cause staggers.\n\n',
                                      ),
                                    ])),
                          ),
                          SizedBox(
