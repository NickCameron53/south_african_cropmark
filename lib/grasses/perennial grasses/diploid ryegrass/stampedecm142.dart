...
class StampedeScreen extends StatefulWidget {
  const StampedeScreen({
    Key? key,
  ...
  @override
  State<StampedeScreen> createState() => _StampedeScreenState();
}

class _StampedeScreenState extends State<StampedeScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Stampede'),
                  const SizedBox(height: 10),
                  const Text(
                    'Late heading with a high leaf : stem ratio.',
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      GlobalWidgets.buildBulletPoint(
                          'Late heading with a high leaf : stem ratio'),
                      GlobalWidgets.buildBulletPoint(
                          'Bred to be persistent with dense tillering'),
                      GlobalWidgets.buildBulletPoint(
                          'Good "stay green" factor into summer'),
                    ],
                  ),
                  ...
                  GlobalWidgets.buildActionButton(
                    ...
                    onPressed: () => _launchURL(
                        'https://www.cropmarkseeds.com/au/forage-seeds/stampede/'),
                  ),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Late +11 days'),
                  const SizedBox(height: 10),
                  ...
                  GlobalWidgets.buildDownloadButton(
                    text: 'Brochure',
                    onPressed: () => _launchURL(
                        'https://www.cropmarkseeds.com/wp-content/uploads/2024/06/Stampede_Brochure_FR.pdf'),
