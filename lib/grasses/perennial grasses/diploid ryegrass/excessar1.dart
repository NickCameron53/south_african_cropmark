...
class excessar1 extends StatefulWidget {
  excessar1({
    Key? key,
  ...
  @override
  State<excessar1> createState() {
    return _excessar1State();
  }
}

class _excessar1State extends State<excessar1> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('A medium leaved, persistent variety',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/perennial/excess');
                                },
