...
class requestar1 extends StatefulWidget {
  requestar1({
    Key? key,
  ...
  @override
  State<requestar1> createState() {
    return _requestar1State();
  }
}

class _requestar1State extends State<requestar1> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Produces strongly through the spring & autumn.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Request-Agrinote.pdf');
                                },
