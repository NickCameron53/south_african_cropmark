...
class nuinil extends StatefulWidget {
  nuinil({
    Key? key,
  ...
  @override
  State<nuinil> createState() {
    return _nuinilState();
  }
}

class _nuinilState extends State<nuinil> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Public bred variety, used as standard in industry trials.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://luisettiseeds.co.nz/product/perennial-ryegrass/');
                                },
