...
class NuiScreen extends StatefulWidget {
  const NuiScreen({
    Key? key,
  ...
  @override
  State<NuiScreen> createState() => _NuiScreenState();
}

class _NuiScreenState extends State<NuiScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Nui'),
