...
class matrixnil extends StatefulWidget {
  matrixnil({
    Key? key,
  ...
  @override
  State<matrixnil> createState() {
    return _matrixnilState();
  }
}

class _matrixnilState extends State<matrixnil> {
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            ...
                            'Matrix stands out with strong insect tolerance and disease resistance (particularly Leaf Rust and Net Blotch) and low aftermath heading, swiftly returning to a vegetative state for improved late spring forage quality. Available in both standard and low endophyte options.',
                        ...
                        SizedBox(
                          width: double.infinity,
                          child: Text('Available Endophytes',
                              textAlign: TextAlign.left,
                              style: TextStyle(
                                  fontSize: 24,
                                  fontWeight: FontWeight.bold,
