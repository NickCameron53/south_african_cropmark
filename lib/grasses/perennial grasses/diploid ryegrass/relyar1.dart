...
class RelyScreen extends StatefulWidget {
  const RelyScreen({
    Key? key,
  ...
  @override
  State<RelyScreen> createState() => _RelyScreenState();
}

class _RelyScreenState extends State<RelyScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Rely'),
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'A fine leafed, densely tillered variety suited to dairy, sheep & beef systems.'),
                      GlobalWidgets.buildBulletPoint(
                          'Can tolerate lower fertility & set stocking.'),
                    ],
                  ),
