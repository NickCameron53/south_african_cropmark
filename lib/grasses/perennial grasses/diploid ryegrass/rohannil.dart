...
class RohanScreen extends StatefulWidget {
  const RohanScreen({
    Key? key,
  ...
  @override
  State<RohanScreen> createState() => _RohanScreenState();
}

class _RohanScreenState extends State<RohanScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Rohan'),
                  const SizedBox(height: 10),
                  const Text(
                    'A persistent spreading cultivar.',
