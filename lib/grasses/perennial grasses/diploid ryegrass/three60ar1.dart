...
class Three60Screen extends StatefulWidget {
  const Three60Screen({
    Key? key,
  ...
  @override
  State<Three60Screen> createState() => _Three60ScreenState();
}

class _Three60ScreenState extends State<Three60Screen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Three\u2076\u2070 '),
