...
class three60ar1 extends StatefulWidget {
  three60ar1({
    Key? key,
  ...
  @override
  State<three60ar1> createState() {
    return _three60ar1State();
  }
}

class _three60ar1State extends State<three60ar1> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Very high dry matter producing cultivar with good spring quality.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/ryegrass/perennial/three60');
                                },
