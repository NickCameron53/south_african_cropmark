...
class trojannil extends StatefulWidget {
  trojannil({
    Key? key,
  ...
  @override
  State<trojannil> createState() {
    return _trojannilState();
  }
}

class _trojannilState extends State<trojannil> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Good resistance to plant pulling.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/news/nea2-%E2%80%93-best-endophyte-for-the-best-pastures.htm');
                                },
