...
class TrojanScreen extends StatefulWidget {
  const TrojanScreen({
    Key? key,
  ...
  @override
  State<TrojanScreen> createState() => _TrojanScreenState();
}

class _TrojanScreenState extends State<TrojanScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Trojan'),
                  const SizedBox(height: 10),
                  const Text(
                    'Good resistance to plant pulling.',
