...
class samsonnil extends StatefulWidget {
  samsonnil({
    Key? key,
  ...
  @override
  State<samsonnil> createState() {
    return _samsonnilState();
  }
}

class _samsonnilState extends State<samsonnil> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('An older, medium tillered semi-erect cultivar.',
                            style:
                        ...
                        Text(
                            ...
                            "\n\u25BA Good summer & autumn production proving productive under sheep & beef management.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/ryegrass/perennial/samson');
                                },
