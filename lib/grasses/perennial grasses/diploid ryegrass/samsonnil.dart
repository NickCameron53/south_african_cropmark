...
class SamsonScreen extends StatefulWidget {
  const SamsonScreen({
    Key? key,
  ...
  @override
  State<SamsonScreen> createState() => _SamsonScreenState();
}

class _SamsonScreenState extends State<SamsonScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Samson'),
                  const SizedBox(height: 10),
                  const Text(
                    'An older, medium tillered semi-erect cultivar.',
