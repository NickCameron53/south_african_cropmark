...
class sequelstandard extends StatefulWidget {
  sequelstandard({
    Key? key,
  ...
  @override
  State<sequelstandard> createState() {
    return _sequelstandardState();
  }
}

class _sequelstandardState extends State<sequelstandard> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A high-performing, densely tillered, and late-heading perennial ryegrass, Sequel Enhanced guarantees year-round growth even under moderate pressure from top-feeding insects and during cool seasons.'
                            '\nSequel Enhanced stands out with its superb pasture quality, boasting high metabolisable energy and digestibility, ensuring optimal livestock nutrition. Highly palatable and with strong persistence, Sequel Enhanced maintains its vigour, supported by robust disease resistance (including Leaf Rust). Its late heading trait prolongs pasture quality into spring, complemented by low aftermath heading.'
                            '\nBest suited to rational grazing under dairy, beef and sheep grazing systems - available with standard endophyte.',
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.cropmarkseeds.com/Forage-Products-from-Cropmark-Seeds/Sequel-Enhanced-Perennial-Ryegrass');
                                },
                        ...
                        // ==================   standard endophyte information ============================================
                        if (selectedIndex1 ==
                            endophytetype.indexOf('Standard')) ...[
                          SizedBox(height: 10),
                          SizedBox(
                            width: double.infinity,
                            child: RichText(
                                ...
                                text: TextSpan(
                                    ...
                                    children: [
                                      ...
                                      TextSpan(
                                        text:
                                            '\nProduces animal safe alkaloid Peramine. Lolitrem B and Ergovaline alkaloids are also produced.',
                                      ),
                                    ])),
                          ),
                          SizedBox(height: 20),
