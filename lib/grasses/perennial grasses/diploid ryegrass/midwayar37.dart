...
class midwayar37 extends StatefulWidget {
  midwayar37({
    Key? key,
  ...
  @override
  State<midwayar37> createState() {
    return _midwayar37State();
  }
}

class _midwayar37State extends State<midwayar37> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Selected for low aftermath heading.',
                            style:
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Has high seasonal dry matter production and tiller density."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/perennial/midway');
                                },
