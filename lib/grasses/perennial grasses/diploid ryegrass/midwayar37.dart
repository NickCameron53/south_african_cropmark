...
class MidwayScreen extends StatefulWidget {
  ...
  @override
  State<MidwayScreen> createState() => _MidwayScreenState();
}

class _MidwayScreenState extends State<MidwayScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Midway'),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Early +3 days'),
                  const SizedBox(height: 10),
