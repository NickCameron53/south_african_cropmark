...
class abermagicnil extends StatefulWidget {
  abermagicnil({
    Key? key,
  ...
  @override
  State<abermagicnil> createState() {
    return _abermagicnilState();
  }
}

class _abermagicnilState extends State<abermagicnil> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://germinal.co.nz/product/abermagic/');
                                },
