...
class AbermagicScreen extends StatefulWidget {
  const AbermagicScreen({
    Key? key,
  ...
  @override
  State<AbermagicScreen> createState() => _AbermagicScreenState();
}

class _AbermagicScreenState extends State<AbermagicScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Abermagic'),
