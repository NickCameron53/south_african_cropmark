...
class expoar1 extends StatefulWidget {
  expoar1({
    Key? key,
  ...
  @override
  State<expoar1> createState() {
    return _expoar1State();
  }
}

class _expoar1State extends State<expoar1> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/perennial/expo');
                                },
