...
class one50nil extends StatefulWidget {
  one50nil({
    Key? key,
  ...
  @override
  State<one50nil> createState() {
    return _one50nilState();
  }
}

class _one50nilState extends State<one50nil> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/ryegrass/perennial/one50');
                                },
