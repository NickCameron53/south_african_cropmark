...
class AbergreenScreen extends StatefulWidget {
  const AbergreenScreen({
    Key? key,
  ...
  @override
  State<AbergreenScreen> createState() => _AbergreenScreenState();
}

class _AbergreenScreenState extends State<AbergreenScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Abergreen'),
                  const SizedBox(height: 10),
                  const Text(
                    'Selected for improved sugar levels.',
