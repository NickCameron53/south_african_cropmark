...
class barrieru2 extends StatefulWidget {
  barrieru2({
    Key? key,
  ...
  @override
  State<barrieru2> createState() {
    return _barrieru2State();
  }
}

class _barrieru2State extends State<barrieru2> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('A persistent perennial inter-species cross.',
                            style:
                        ...
                        if (selectedIndex1 == endophytetype.indexOf('U2')) ...[
                          SizedBox(height: 10),
                          SizedBox(
                            width: double.infinity,
                            child: RichText(
