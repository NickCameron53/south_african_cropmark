...
class ViscountScreen extends StatefulWidget {
  const ViscountScreen({
    Key? key,
  ...
  @override
  State<ViscountScreen> createState() => _ViscountScreenState();
}

class _ViscountScreenState extends State<ViscountScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Viscount'),
