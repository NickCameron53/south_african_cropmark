...
class viscountnil extends StatefulWidget {
  viscountnil({
    Key? key,
  ...
  @override
  State<viscountnil> createState() {
    return _viscountnilState();
  }
}

class _viscountnilState extends State<viscountnil> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA An upright variety offering good early spring growth with good palatability."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/endophyte-upgrade-to-nea4-for-viscount-perennial-ryegrass.htm');
                                },
