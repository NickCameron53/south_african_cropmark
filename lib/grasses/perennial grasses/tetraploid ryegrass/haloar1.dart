...
class haloar1 extends StatefulWidget {
  haloar1({
    Key? key,
  ...
  @override
  State<haloar1> createState() {
    return _haloar1State();
  }
}

class _haloar1State extends State<haloar1> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://store.pggwrightson.co.nz/agricom-halo-ryegrass-00747');
                                },
