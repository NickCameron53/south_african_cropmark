...
class fourfrontnea2 extends StatefulWidget {
  fourfrontnea2({
    Key? key,
  ...
  @override
  State<fourfrontnea2> createState() {
    return _fourfrontnea2State();
  }
}

class _fourfrontnea2State extends State<fourfrontnea2> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A more densely tillered and high yielding cultivar.',
                            style:
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA A new medium to late heading more densely tillered and high yielding tetraploid cultivar."
                            "\n\u25BA Contains NEA4 endophyte.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/grass-cultivars/perennial-ryegrass/4front-2.htm');
                                },
