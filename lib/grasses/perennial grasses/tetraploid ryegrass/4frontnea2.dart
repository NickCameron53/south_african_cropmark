...
class FourFrontScreen extends StatefulWidget {
  const FourFrontScreen({
    Key? key,
  ...
  @override
  State<FourFrontScreen> createState() => _FourFrontScreenState();
}

class _FourFrontScreenState extends State<FourFrontScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('4Front'),
