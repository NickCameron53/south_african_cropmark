...
class AbergainScreen extends StatefulWidget {
  const AbergainScreen({
    Key? key,
  ...
  @override
  State<AbergainScreen> createState() => _AbergainScreenState();
}

class _AbergainScreenState extends State<AbergainScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Abergain'),
                  const SizedBox(height: 10),
                  const Text(
                    'Selected for improved palatability and high sugar levels.',
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'A densely tillered variety which offers improved spring growth.'),
                      GlobalWidgets.buildBulletPoint(
                          'Selected for improved palatability and high sugar levels.'),
                    ],
                  ),
