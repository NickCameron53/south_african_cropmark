...
class alignar37 extends StatefulWidget {
  alignar37({
    Key? key,
  ...
  @override
  State<alignar37> createState() {
    return _alignar37State();
  }
}

class _alignar37State extends State<alignar37> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            "\u25BA  High annual yields. "
                                "\n\u25BA Align's dense habit creates better ground cover that can be more tolerant of grazing damage in early spring."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/ryegrass/perennial/align');
                                },
                        ...
                        SizedBox(height: 10),
                        Text('Suited to high performance farming systems.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Align%20Agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
