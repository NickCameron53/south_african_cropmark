          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Align'),
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'High annual yields.'),
                      GlobalWidgets.buildBulletPoint(
                          'Align has a dense habit which creates better ground cover that can be more tolerant of grazing damage in early spring.'),
                      GlobalWidgets.buildBulletPoint(
                  ...
                  GlobalWidgets.buildInfoRow(
                      'Heading date', 'Very Late +35 days'),
                  const SizedBox(height: 10),
