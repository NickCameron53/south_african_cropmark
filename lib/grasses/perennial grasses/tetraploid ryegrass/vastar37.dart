...
class vastar37 extends StatefulWidget {
  vastar37({
    Key? key,
  ...
  @override
  State<vastar37> createState() {
    return _vastar37State();
  }
}

class _vastar37State extends State<vastar37> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/perennial/vast');
                                },
