...
class KainuiScreen extends StatefulWidget {
  const KainuiScreen({
    Key? key,
  ...
  @override
  State<KainuiScreen> createState() => _KainuiScreenState();
}

class _KainuiScreenState extends State<KainuiScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Kainui'),
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'Kainui is a new cocksfoot cultivar bred for high yields, good compatibility within pasture mixes and strong root development for summer dry tolerance.'),
                      GlobalWidgets.buildBulletPoint(
                          'Kainui has high tiller density, and soft ryegrass-like leaves, with very good disease resistance.'),
                      GlobalWidgets.buildBulletPoint(
                          'It is well suited for inclusion in pasture mixes or as a specialist pasture in summer-dry areas.'),
                      GlobalWidgets.buildBulletPoint(
                          'Well suited to rotational grazing or set stocking.'),
                      GlobalWidgets.buildBulletPoint(
                          'Clover friendly with good grazing management, to be used in summer or winter dry areas for sheep or dairy.'),
                    ],
                  ),
                  ...
                  GlobalWidgets.buildActionButton(
                    ...
                    onPressed: () => _launchURL(
                        'https://www.cropmarkseeds.com/Forage-Products-from-Cropmark-Seeds/Kainui-cocksfoot'),
                  ),
                  ...
                  GlobalWidgets.buildDownloadButton(
                    text: 'Tech Sheet',
                    onPressed: () => _launchURL(
                        'https://www.cropmarkseeds.com/wp-content/uploads/2025/10/Kainui_TS.pdf'),
