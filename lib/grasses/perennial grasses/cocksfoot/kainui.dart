...
class kainui extends StatefulWidget {
  kainui({
    Key? key,
  ...
  @override
  State<kainui> createState() {
    return _kainuiState();
  }
}

class _kainuiState extends State<kainui> {
  @override
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.cropmarkseeds.com/wp-content/uploads/2024/06/Kainui_TS-1.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
