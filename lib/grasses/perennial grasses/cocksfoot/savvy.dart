...
class savvy extends StatefulWidget {
  savvy({
    Key? key,
  ...
  @override
  State<savvy> createState() {
    return _savvyState();
  }
}

class _savvyState extends State<savvy> {
  @override
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/grasses/cocksfoot/savvy');
                                },
