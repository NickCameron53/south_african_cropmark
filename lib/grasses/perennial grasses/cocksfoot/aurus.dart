...
class aurus extends StatefulWidget {
  aurus({
    Key? key,
  ...
  @override
  State<aurus> createState() {
    return _aurusState();
  }
}

class _aurusState extends State<aurus> {
  @override
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/cocksfoot/aurus');
                                },
