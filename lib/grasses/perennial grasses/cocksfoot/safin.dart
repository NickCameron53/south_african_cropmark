...
class SafinScreen extends StatefulWidget {
  const SafinScreen({
    Key? key,
  ...
  @override
  State<SafinScreen> createState() => _SafinScreenState();
}

class _SafinScreenState extends State<SafinScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Safin'),
                  const SizedBox(height: 10),
                  const Text(
                    'Has improved early spring production.',
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      GlobalWidgets.buildBulletPoint(
                          'Has improved early spring production.'),
                      GlobalWidgets.buildBulletPoint(
                          'Less aggressive type with good compatibility with ryegrass.'),
                    ],
                  ),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Early to Medium'),
                  const SizedBox(height: 10),
