...
class safin extends StatefulWidget {
  safin({
    Key? key,
  ...
  @override
  State<safin> createState() {
    return _safinState();
  }
}

class _safinState extends State<safin> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Has improved early spring production.',
                            style:
