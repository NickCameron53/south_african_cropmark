...
class indulgence extends StatefulWidget {
  indulgence({
    Key? key,
  ...
  @override
  State<indulgence> createState() {
    return _indulgenceState();
  }
}

class _indulgenceState extends State<indulgence> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A European bred, densely tillered, fine leafed variety.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://ragt.nz/product/indulgence/');
                                },
