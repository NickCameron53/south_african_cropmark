...
class lushar37 extends StatefulWidget {
  lushar37({
    Key? key,
  ...
  @override
  State<lushar37> createState() {
    return _lushar37State();
  }
}

class _lushar37State extends State<lushar37> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A more persistent tetraploid cultivar with relatively low aftermath heading',
                            style:
                        ...
                        Text(
                            "\u25BA A more persistent tetraploid cultivar with relatively low aftermath heading."
                            "\n\u25BA It can cause ryegrass staggers and should only be used as an under sowing option."
                            "\n\u25BA Good rust tolerance.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/italian/lush');
                                },
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Suited to high performance farming systems with high insect pressure.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
