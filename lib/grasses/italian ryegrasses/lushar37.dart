...
class LushScreen extends StatefulWidget {
  const LushScreen({
    Key? key,
  ...
  @override
  State<LushScreen> createState() => _LushScreenState();
}

class _LushScreenState extends State<LushScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Lush'),
