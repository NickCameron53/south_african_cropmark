...
class Feast2Screen extends StatefulWidget {
  const Feast2Screen({
    Key? key,
  ...
  @override
  State<Feast2Screen> createState() => _Feast2ScreenState();
}

class _Feast2ScreenState extends State<Feast2Screen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Feast II'),
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'A tetraploid Italian ryegrass selection from Concord with a similar heading date.'),
                      GlobalWidgets.buildBulletPoint(
                          'Very high quality and animal acceptability.'),
                    ],
                  ),
