...
class feast2 extends StatefulWidget {
  feast2({
    Key? key,
  ...
  @override
  State<feast2> createState() {
    return _feast2State();
  }
}

class _feast2State extends State<feast2> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/italian/feast-ii');
                                },
