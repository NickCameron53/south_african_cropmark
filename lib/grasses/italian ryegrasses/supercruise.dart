...
class SupercruiseScreen extends StatefulWidget {
  const SupercruiseScreen({
    Key? key,
  ...
  @override
  State<SupercruiseScreen> createState() => _SupercruiseScreenState();
}

class _SupercruiseScreenState extends State<SupercruiseScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Supercruise'),
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'Displaying all the required attributes of a high quality diploid Italian ryegrass.'),
                      GlobalWidgets.buildBulletPoint(
                          'A reliable option for undersowing into worn out pastures.'),
                    ],
                  ),
