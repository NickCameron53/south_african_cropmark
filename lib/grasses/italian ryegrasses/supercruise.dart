...
class supercruise extends StatefulWidget {
  supercruise({
    Key? key,
  ...
  @override
  State<supercruise> createState() {
    return _supercruiseState();
  }
}

class _supercruiseState extends State<supercruise> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/grasses/italian/supercruise');
                                },
