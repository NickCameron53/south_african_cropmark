...
class GrasslandsAssetScreen extends StatefulWidget {
  const GrasslandsAssetScreen({
    Key? key,
  ...
  @override
  State<GrasslandsAssetScreen> createState() => _GrasslandsAssetScreenState();
}

class _GrasslandsAssetScreenState extends State<GrasslandsAssetScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Asset'),
                  const SizedBox(height: 10),
                  const Text(
                    'A cultivar with higher tiller density and relatively low aftermath heading.',
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      GlobalWidgets.buildBulletPoint(
                          'A more persistent cultivar with higher tiller density and relatively low aftermath heading.'),
                    ],
                  ),
