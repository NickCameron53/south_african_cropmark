...
class MoataScreen extends StatefulWidget {
  const MoataScreen({
    Key? key,
  ...
  @override
  State<MoataScreen> createState() => _MoataScreenState();
}

class _MoataScreenState extends State<MoataScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Moata'),
                  const SizedBox(height: 10),
                  const Text(
                    'An older public tetraploid cultivar with strong establishment and good winter activity.',
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'An older public tetraploid cultivar with strong establishment and good winter activity.'),
                      GlobalWidgets.buildBulletPoint(
                          'Has limited persistence and will not tolerate drier summer conditions.'),
                    ],
                  ),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Medium to Late +16 days'),
                  const SizedBox(height: 10),
