...
class moata extends StatefulWidget {
  moata({
    Key? key,
  ...
  @override
  State<moata> createState() {
    return _moataState();
  }
}

class _moataState extends State<moata> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://luisettiseeds.co.nz/product/moata-italian-ryegrass/');
                                },
                          ...
                          child: RichText(
                              ...
                              text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      text:
                                          '12 to 24 months subject to climate',
                                    ),
                                  ])),
                        ),
                        SizedBox(height: 10),
