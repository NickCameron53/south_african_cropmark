...
class PerunScreen extends StatefulWidget {
  const PerunScreen({
    Key? key,
  ...
  @override
  State<PerunScreen> createState() => _PerunScreenState();
}

class _PerunScreenState extends State<PerunScreen> {
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            Text(
              'Italian ryegrass x meadow fescue',
              style: TextStyle(
                color: Colors.white,
                fontSize: 15.0,
              ),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Perun'),
                  const SizedBox(height: 10),
                  const Text(
                    'Good cold tolerance, lower winter activity but strong spring growth.',
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Heading date', 'Medium +12 days'),
                  const SizedBox(height: 10),
