...
class perun extends StatefulWidget {
  perun({
    Key? key,
  ...
  @override
  State<perun> createState() {
    return _perunState();
  }
}

class _perunState extends State<perun> {
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://dlf.com/seeds/forage-agriculture/species-and-varieties/plus-festulolium-lolium-type/details/forage/plus-festulolium-lolium-type/perun-21100701');
                                },
