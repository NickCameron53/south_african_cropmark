          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Vibe'),
                  const SizedBox(height: 10),
                  const Text(
                    'High-yielding with strong persistence in harsh conditions.',
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'Vibe showcases strong persistence even in harsh conditions, bouncing back from hard grazings.'),
                      GlobalWidgets.buildBulletPoint(
                          'A consistently high performer, Vibe maintains pasture quality well into early summer with late heading and minimal aftermath heading.'),
                      GlobalWidgets.buildBulletPoint(
                          'Ideal for use as a short term, high quality feed, or for direct drilling into damaged or run-out pastures.'),
                    ],
                  ),
                  ...
                  GlobalWidgets.buildInfoRow(
                      'Heading date', 'Late to Very Late +26 days'),
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow(
                  ...
                  GlobalWidgets.buildDownloadButton(
                    text: 'Brochure',
                    onPressed: () => _launchURL(
                        'https://www.cropmarkseeds.com/wp-content/uploads/2025/10/Vibe_B_1.pdf'),
