...
import '../../select%20species/forage%20grass/cocksfoot.dart';
...
class Cocksfoots extends StatelessWidget {
  ...
  List<GrassOption> _buildOptions() {
    ...
    summerrain.trim().startsWith("Low");
    ...
    if (isTotalRainLow && isSoilAcidic) {
      options.add(GrassOption(
        image: 'assets/cocksfootpic.png',
        heading: 'Cocksfoot',
        description:
        "Annual rainfall and soil acidity are too low for reliable growth of Cocksfoot.",
        link: Container(),
      ...
      options.add(GrassOption(
        ...
        heading: 'Cocksfoot',
        description:
        "The annual rainfall is too low for good Cocksfoot growth.",
        link: Container(),
        showCultivarsButton: false,
      ));
      ...
      options.add(GrassOption(
        image: 'assets/cocksfootpic.png',
        heading: 'Cocksfoot',
        description: "The soil acidity is too low for good Cocksfoot growth.",
        link: Container(),
        showCultivarsButton: false,
      ));
    }

    // ALL conditions are suitable - add Cocksfoot options
      ...
      options.add(GrassOption(
        ...
        link: Cocksfoot(country: country, region: region),
