                            ...
                            children: [
                              ...
                              Container(
                                child: cultivarcardcocksfoot(
                                    title: 'Kainui',
                                    link: kainui(country: widget.country, region: widget.region,),
                                    description:
                              ...
                              Container(
                                child: cultivarcardcocksfoot(
                                    title: 'Vision',
                                    link: vision(country: widget.country, region: widget.region,),
                                    description:
                              ...
                              Container(
                                child: cultivarcardcocksfoot(
                                    title: 'Redefine',
                                    link: redefine(country: widget.country, region: widget.region,),
                                    description:
                              ...
                              Container(
                                child: cultivarcardcocksfoot(
                                    title: 'Aurus',
                                    link: aurus(country: widget.country, region: widget.region,),
                                    description:
                              ...
                              Container(
                                child: cultivarcardcocksfoot(
                                    title: 'Greenly II',
                                    link: greenly2(country: widget.country, region: widget.region,),
                                    description:
                              ...
                              Container(
                                child: cultivarcardcocksfoot(
                                    ...
                                    link: savvy(country: widget.country, region: widget.region,),
                                    description:
                                        'An upright winter-active and later heading cocksfoot with good winter growth and strong disease resistance.',
                                    date: 'Medium',
                                    type: 'Continental'),
                              ...
                              Container(
                                child: cultivarcardcocksfoot(
                                    title: 'Safin',
                                    link: safin(country: widget.country, region: widget.region,),
                                    description:
