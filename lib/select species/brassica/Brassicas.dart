...
class brassicas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (animaltype != "Horses") {
      ...
      links.add(kale(country: country, region: region,));
      ...
      links.add(rape(country: country, region: region,));
      ...
      links.add(swede(country: country, region: region,));
      ...
      links.add(turnip(country: country, region: region,));
