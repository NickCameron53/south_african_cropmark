...
class KokomoScreen extends StatefulWidget {
  const KokomoScreen({
    Key? key,
  ...
  @override
  State<KokomoScreen> createState() => _KokomoScreenState();
}

class _KokomoScreenState extends State<KokomoScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Kokomo'),
                  const SizedBox(height: 10),
                  const Text(
                    'A consistently high yielding, with large top growth.',
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Bulb above ground', '+/-50%'),
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Bulb Dry matter', '14-16%'),
                  const SizedBox(height: 10),
                  ...
                  Text('*Subject to management and climatic conditions.',
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Aphids', 'good tolerance'),
                  ...
                  GlobalWidgets.buildDownloadButton(
                    text: 'Brochure',
                    onPressed: () => _launchURL(
                        'https://www.cropmarkseeds.com/wp-content/uploads/2025/10/Kokomo_B_1.pdf'),
                  ...
                  GlobalWidgets.buildDownloadButton(
                    text: 'Tech Sheet',
                    onPressed: () => _launchURL(
                        'https://www.cropmarkseeds.com/wp-content/uploads/2025/10/Kokomo-tech-sheet.pdf'),
                    icon: MdiIcons.fileOutline,
                  ),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Sowing season', 'Spring'),
