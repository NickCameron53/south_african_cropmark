...
class captaincsp extends StatefulWidget {
  captaincsp({
    Key? key,
  ...
  @override
  State<captaincsp> createState() {
    return _captaincspState();
  }
}

class _captaincspState extends State<captaincsp> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Improved cool-season activity and summer yields.',
                            style:
                        ...
                        Text(
                            ...
                            "\n\u25BA Used for additional protein and feed quality over the warmer months.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/herbs/captain-plantain-csp-2.htm');
                                },
                                  ...
                                  children: [
                                    TextSpan(
                                        ...
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold)),
                                    TextSpan(
                                      text: 'Mid Spring to late Autumn',
                                    ),
                                  ])),
                        ),
                        SizedBox(height: 10),
