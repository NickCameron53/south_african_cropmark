...
class CaptaincspScreen extends StatefulWidget {
  const CaptaincspScreen({
    Key? key,
  ...
  @override
  State<CaptaincspScreen> createState() => _CaptaincspScreenState();
}

class _CaptaincspScreenState extends State<CaptaincspScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Captain CSP'),
