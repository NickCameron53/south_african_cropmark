...
class EcotainScreen extends StatefulWidget {
  const EcotainScreen({
    Key? key,
  ...
  @override
  State<EcotainScreen> createState() => _EcotainScreenState();
}

class _EcotainScreenState extends State<EcotainScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Ecotain'),
                  ...
                  GlobalWidgets.buildInfoRow(
                      'Growth Peaks', 'Mid Spring to Late Autumn'),
                  const SizedBox(height: 10),
