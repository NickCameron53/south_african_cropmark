...
class ecotain extends StatefulWidget {
  ecotain({
    Key? key,
  ...
  @override
  State<ecotain> createState() {
    return _ecotainState();
  }
}

class _ecotainState extends State<ecotain> {
  @override
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/herbs/plantain/ecotain');
                                },
