...
class agritonic extends StatefulWidget {
  agritonic({
    Key? key,
  ...
  @override
  State<agritonic> createState() {
    return _agritonicState();
  }
}

class _agritonicState extends State<agritonic> {
  @override
