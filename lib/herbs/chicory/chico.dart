...
class ChicoScreen extends StatefulWidget {
  const ChicoScreen({
    Key? key,
  ...
  @override
  State<ChicoScreen> createState() => _ChicoScreenState();
}

class _ChicoScreenState extends State<ChicoScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Chico'),
                  ...
                  GlobalWidgets.buildDownloadButton(
                    text: 'Tech Sheet',
                    onPressed: () => _launchURL(
                        'https://www.cropmarkseeds.com/wp-content/uploads/2025/10/Chico-tech-sheet.pdf'),
