...
class torlesse extends StatefulWidget {
  torlesse({
    Key? key,
  ...
  @override
  State<torlesse> createState() {
    return _torlesseState();
  }
}

class _torlesseState extends State<torlesse> {
  @override
                    ...
                    child: Column(
                      children: [
                        SizedBox(
                          ...
                          child: Text('Grasslands Torlesse',
                        ...
                        Text(
                            "\u25BA A highly persistent winter dormant NZ bred variety."
                            "\n\u25BA It is high yielding, fine stemmed and has good resistance to most pests and diseases.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/legumes/lucerne/torlesse');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Torlesse-agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
