...
class sf914ql extends StatefulWidget {
  sf914ql({
    Key? key,
  ...
  @override
  State<sf914ql> createState() {
    return _sf914qlState();
  }
}

class _sf914qlState extends State<sf914ql> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA 914QL is a highly winter active type developed for growers looking for maximum production in suitable environments."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL('https://ragt.nz/product/914ql/');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://ragt.nz/wp-content/uploads/2020/09/914QL-lucerne_product-sheet.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
