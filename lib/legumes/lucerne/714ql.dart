...
class sf714ql extends StatefulWidget {
  sf714ql({
    Key? key,
  ...
  @override
  State<sf714ql> createState() {
    return _sf714qlState();
  }
}

class _sf714qlState extends State<sf714ql> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            "\u25BA A semi-winter active soft stemmed variety suitable for cutting or grazing."
                            "\n\u25BA It can provide extended growth through the shoulders of the growing season and is a great addition to existing systems currently utilising predominately semi-dormant types.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL('https://ragt.nz/product/714ql/');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://ragt.nz/wp-content/uploads/2020/09/714QL-lucerne_product-sheet.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
