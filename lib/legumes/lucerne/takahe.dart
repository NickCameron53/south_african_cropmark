...
class takahe extends StatefulWidget {
  takahe({
    Key? key,
  ...
  @override
  State<takahe> createState() {
    return _takaheState();
  }
}

class _takaheState extends State<takahe> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA A New Zealand bred lucerne variety."
                            "\n\u25BA It has been bred for superior shoot density, and grows excellent quality forage with improved leaf:stem ratios."
                            "\n\u25BA Ideally Takahē™ should be rotationally grazed or harvested at 4 to 6-week intervals. Recovers rapidly."
                            "\n\u25BA Dormancy rating of 4. Moderate to low level of winter production but good spring, and excellent summer and autumn growth.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://luisettiseeds.co.nz/product/takahe/');
                                },
