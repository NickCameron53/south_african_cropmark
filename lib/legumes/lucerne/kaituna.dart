...
class kaituna extends StatefulWidget {
  kaituna({
    Key? key,
  ...
  @override
  State<kaituna> createState() {
    return _kaitunaState();
  }
}

class _kaitunaState extends State<kaituna> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Bred from New Zealand and American germplasm."
                            "\n\u25BA Fine stemmed."
                            "\n\u25BA Highly persistent."
                            "\n\u25BA A general purpose variety."
                            "\n\u25BA Consistent performer throughout the North Island.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/kaituna');
                                },
