...
class force4 extends StatefulWidget {
  force4({
    Key? key,
  ...
  @override
  State<force4> createState() {
    return _force4State();
  }
}

class _force4State extends State<force4> {
  @override
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            ...
                            "\n\u25BA Shows good early season growth and good persistence."
                            "\n\u25BA Multi-stemmed with upright growth habit."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL('https://ragt.nz/product/force-4/');
                                },
