...
class staminagt5 extends StatefulWidget {
  staminagt5({
    Key? key,
  ...
  @override
  State<staminagt5> createState() {
    return _staminagt5State();
  }
}

class _staminagt5State extends State<staminagt5> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            "\u25BA Bred for increased persistence, enabling it to tolerate set stocking and close grazing."
                            "\n\u25BA Produces excellent hay quality.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.dlfseeds.com.au/products/legumes/lucerne/stamina-gt5');
                                },
