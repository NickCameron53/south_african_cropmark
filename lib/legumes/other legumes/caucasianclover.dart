...
class caucasianclover extends StatefulWidget {
  caucasianclover({
    Key? key,
  ...
  @override
  State<caucasianclover> createState() {
    return _caucasiancloverState();
  }
}

class _caucasiancloverState extends State<caucasianclover> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\n\u25BA Once established caucasian clover offers strong spring and summer growth and is very tolerant of grass grub attack."
                            "\n\u25BA Winter dormant."
                            "\n\u25BA Under drought conditions it becomes dormant to persist.",
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Useful for areas prone to drought and under grass grub stress.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
