...
class taipan extends StatefulWidget {
  taipan({
    Key? key,
  ...
  @override
  State<taipan> createState() {
    return _taipanState();
  }
}

class _taipanState extends State<taipan> {
  @override
                      ...
                      children: [
                        ...
                        Text(
                            "\n\u25BA Mid-season annual clover providing early spring feed."
                                ...
                                "\n\u25BA Good adaptability across a wide range of soil types and pH levels. Tolerant to waterlogging."
                                "\n\u25BA Good for hay.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL('https://pggwrightsonseeds.com/pasture/clover/balansa-clover/taipan');
                                },
