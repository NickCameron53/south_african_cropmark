...
class persianclover extends StatefulWidget {
  persianclover({
    Key? key,
  ...
  @override
  State<persianclover> createState() {
    return _persiancloverState();
  }
}

class _persiancloverState extends State<persianclover> {
  @override
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/sheep-beef-deer/cultivars/clover/annual-clover/laser.htm');
                                },
