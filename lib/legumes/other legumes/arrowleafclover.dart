...
class arrowleafclover extends StatefulWidget {
  arrowleafclover({
    Key? key,
  ...
  @override
  State<arrowleafclover> createState() {
    return _arrowleafcloverState();
  }
}

class _arrowleafcloverState extends State<arrowleafclover> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Tap-rooted annual clover with roots that can reach 1.5m deep.',
                            style:
                        ...
                        Text(
                            ...
                            "\n\u25BA Can be used for hay, silage or green manure.\n\u25BA Provides a low bloat risk for cattle.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/clover/annual-clover/zulu-ii.htm');
                                },
