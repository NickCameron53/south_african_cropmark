...
class LotusScreen extends StatefulWidget {
  const LotusScreen({
    Key? key,
  ...
  @override
  State<LotusScreen> createState() => _LotusScreenState();
}

class _LotusScreenState extends State<LotusScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Lotus pedunculatus'),
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'Performs well where other clovers fail and is often used in hill country forestry situations noted for their tough environments.'),
                      GlobalWidgets.buildBulletPoint(
                          'Has a higher tolerance for low soil pH and phosphate deficiency compared to white clover.'),
                    ],
                  ),
                  ...
                  const SizedBox(height: 10),
                  const Text(
                    'Used in hill country forestry and tussock grassland areas.',
