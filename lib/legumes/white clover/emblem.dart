...
class emblem extends StatefulWidget {
  emblem({
    Key? key,
  ...
  @override
  State<emblem> createState() {
    return _emblemState();
  }
}

class _emblemState extends State<emblem> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA A small-medium leaved type. Has small leaves with stolons close to the ground which aids in persistence under set stocking and lower fertility environments."
                            "\n\u25BA High production under periods of set stocking.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/legumes/white-clover/emblem');
                                },
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Recommended for sheep and beef pastures both dryland and higher rainfall.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Agricom%20Emblem%20White%20Clover%20Agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
