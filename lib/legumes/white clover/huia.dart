...
class huia extends StatefulWidget {
  huia({
    Key? key,
  ...
  @override
  State<huia> createState() {
    return _huiaState();
  }
}

class _huiaState extends State<huia> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Huia was first produced in 1957."
                            "\n\u25BA Now superseded by Demand and Prestige."
                            "\n\u25BA A sheep/beef type.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://luisettiseeds.co.nz/product/huia-white-clover/');
                                },
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A general purpose type for sheep, cattle and deer.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
