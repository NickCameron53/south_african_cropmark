...
class quartz extends StatefulWidget {
  quartz({
    Key? key,
  ...
  @override
  State<quartz> createState() {
    return _quartzState();
  }
}

class _quartzState extends State<quartz> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            "\u25BA A persistent white clover that has broad adaptability across environments and farm systems."
                            "\n\u25BA It performs well under both sheep and beef grazing management.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.dlfseeds.com.au/products/legumes/white-clover/seeds-legume-clover-quartz');
                                },
