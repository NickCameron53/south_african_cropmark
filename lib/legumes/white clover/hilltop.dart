...
class hilltop extends StatefulWidget {
  hilltop({
    Key? key,
  ...
  @override
  State<hilltop> createState() {
    return _hilltopState();
  }
}

class _hilltopState extends State<hilltop> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA A small-medium leaved type. Bred to cope with more challenging environments from variable soil fertility to variable moisture availability, Hilltop is a very robust and persistent small-medium leaf white clover."
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.dlfseeds.com.au/products/legumes/white-clover/seeds-legume-clover-hilltop');
                                },
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Used in more challenging environments, from variable soil fertility to variable moisture availability.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Nomad-Agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
