...
class aberlasting extends StatefulWidget {
  aberlasting({
    Key? key,
  ...
  @override
  State<aberlasting> createState() {
    return _aberlastingState();
  }
}

class _aberlastingState extends State<aberlasting> {
  @override
                    ...
                    child: Column(
                      children: [
                        SizedBox(
                          ...
                          child: Text('DoubleRoot hybrid clover',
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A cross of Caucasian clover and small leaved white clover, providing farmers with the benefits of both.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://germinal.co.nz/product/doubleroot-aberlasting-clover/');
                                },
