...
class KotukuScreen extends StatefulWidget {
  const KotukuScreen({
    Key? key,
  ...
  @override
  State<KotukuScreen> createState() => _KotukuScreenState();
}

class _KotukuScreenState extends State<KotukuScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Kotuku'),
                  const SizedBox(height: 10),
                  const Text(
                    'A large leaved cultivar with superior summer growth.',
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'A large leaved cultivar with superior summer growth.'),
                      GlobalWidgets.buildBulletPoint(
                          'It establishes well, has good persistence, and suits both dairying and sheep/beef finishing systems.'),
                    ],
                  ),
