...
class kotuku extends StatefulWidget {
  kotuku({
    Key? key,
  ...
  @override
  State<kotuku> createState() {
    return _kotukuState();
  }
}

class _kotukuState extends State<kotuku> {
  @override
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/clover/white-clover/kotuku.htm');
                                },
