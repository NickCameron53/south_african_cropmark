...
class brace extends StatefulWidget {
  brace({
    Key? key,
  ...
  @override
  State<brace> createState() {
    return _braceState();
  }
}

class _braceState extends State<brace> {
  @override
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.dlfseeds.com.au/products/legumes/white-clover/brace');
                                },
