...
class tribute extends StatefulWidget {
  ...
  @override
  State<tribute> createState() {
    return _tributeState();
  }
}
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/legumes/white-clover/tribute');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Tribute-Agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
