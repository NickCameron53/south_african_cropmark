...
class ApexScreen extends StatefulWidget {
  const ApexScreen({
    Key? key,
  ...
  @override
  State<ApexScreen> createState() => _ApexScreenState();
}

class _ApexScreenState extends State<ApexScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Apex'),
                  ...
                  GlobalWidgets.buildInfoRow('Leaf Size', 'Small to Medium'),
                  const SizedBox(height: 10),
