...
class aberdance extends StatefulWidget {
  aberdance({
    Key? key,
  ...
  @override
  State<aberdance> createState() {
    return _aberdanceState();
  }
}

class _aberdanceState extends State<aberdance> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            "\u25BA Winter hardy so performs well under cooler moist conditions."
                            "\n\u25BA Suited for sheep, cattle and deer under set stocking through to intensive rotational grazing.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://germinal.co.nz/product/aberdance-white-clover/');
                                },
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A general purpose type for dairy, sheep, cattle and deer.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://germinal.co.nz/wp-content/uploads/2019/04/AberDance.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
