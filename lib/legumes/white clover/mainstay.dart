...
class mainstay extends StatefulWidget {
  mainstay({
    Key? key,
  ...
  @override
  State<mainstay> createState() {
    return _mainstayState();
  }
}

class _mainstayState extends State<mainstay> {
  @override
                    ...
                    child: Column(
                      children: [
                        SizedBox(
                          ...
                          child: Text('Grasslands Mainstay',
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Improved persistence and production."
                            "\n\u25BA Shows good recovery after summer drought."
                            "\n\u25BA Some tolerance to clover root weevil."
                            "\n\u25BA Suited for dairy or rotational grazing beef systems.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/legumes/white-clover/mainstay');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Mainstay-Final.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
