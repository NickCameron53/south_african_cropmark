...
class ruru extends StatefulWidget {
  ruru({
    Key? key,
  ...
  @override
  State<ruru> createState() {
    return _ruruState();
  }
}

class _ruruState extends State<ruru> {
  @override
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/clover/white-clover/ruru-2.htm');
                                },
