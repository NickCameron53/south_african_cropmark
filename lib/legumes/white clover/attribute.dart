...
class attribute extends StatefulWidget {
  ...
  @override
  State<attribute> createState() {
    return _attributeState();
  }
}
                    ...
                    child: Column(
                      children: [
                        SizedBox(
                          ...
                          child: Text('Grasslands Attribute',
                        ...
                        SizedBox(height: 10),
                        Text('Suited for most grazing systems.',
                            style:
                        ...
                        Text(
                            ...
                            "\n\u25BA Suited for most grazing systems. Has shown a high level of performance in dryland sheep pastures under both set stocking and rotational grazing in Canterbury."
                            "\n\u25BA Used successfully in intensive rotationally grazed cattle upper North Island pastures.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/legumes/white-clover/attribute');
                                },
                        ...
                        SizedBox(height: 10),
                        Text('Suitable for most grazing systems.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Attribute%20Agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
