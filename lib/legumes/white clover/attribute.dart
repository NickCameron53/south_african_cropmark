    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            const Text(
              'Grasslands Attribute White clover',
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Attribute'),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      GlobalWidgets.buildBulletPoint(
                          'Suited for most grazing systems. Has shown a high level of performance in dryland sheep pastures under both set stocking and rotational grazing.'),
                      GlobalWidgets.buildBulletPoint(
                          'Used successfully in intensive rotationally grazed cattle systems.'),  ],
                  ),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Soil Fertility', 'Medium (Olsen P 15-20)'),
                  const SizedBox(height: 10),
