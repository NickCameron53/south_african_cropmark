...
class abernormous extends StatefulWidget {
  abernormous({
    Key? key,
  ...
  @override
  State<abernormous> createState() {
    return _abernormousState();
  }
}

class _abernormousState extends State<abernormous> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            "\u25BA Bred for stress tolerance, grazing tolerance, pest and disease resistance."
                            "\n\u25BA Suited for lax rotational dairy or beef grazing systems and for silage use.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://germinal.co.nz/product/abernormous-white-clover/');
                                },
                        ...
                        SizedBox(height: 10),
                        Text('Suitable for rotational grazing and cutting.',
                            style: TextStyle(fontSize: 15)),
                        SizedBox(height: 10),
                        Divider(
                          color: Colors.green,
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://germinal.co.nz/wp-content/uploads/2020/08/AberNormous.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
