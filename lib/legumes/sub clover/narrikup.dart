...
class NarrikupScreen extends StatefulWidget {
  const NarrikupScreen({
    Key? key,
  ...
  @override
  State<NarrikupScreen> createState() => _NarrikupScreenState();
}

class _NarrikupScreenState extends State<NarrikupScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Narrikup'),
