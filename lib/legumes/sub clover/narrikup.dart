...
class narrikup extends StatefulWidget {
  narrikup({
    Key? key,
  ...
  @override
  State<narrikup> createState() {
    return _narrikupState();
  }
}

class _narrikupState extends State<narrikup> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'A very vigorous mid season cultivar offering tolerance to Red Legged Earth Mite.',
                            style:
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Black seeded.  Has resistance to both known races of clover scorch, caused by Kabatiella caulivora."
                            "\n\u25BA A very vigorous mid season cultivar offering tolerance to Red Legged Earth Mite.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://ragt.nz/product/narrikup/');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://ragt.nz/wp-content/uploads/2017/03/Narrikup-subterranean-clover_product-sheet.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
