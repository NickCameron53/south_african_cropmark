...
class bindoon extends StatefulWidget {
  bindoon({
    Key? key,
  ...
  @override
  State<bindoon> createState() {
    return _bindoonState();
  }
}

class _bindoonState extends State<bindoon> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Highly productive, early to mid-season cultivar suited to summer-dry areas with well drained soils. "
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://pggwrightsonseeds.com/pasture/clover/subterranean-clover/bindoon');
                                },
