...
class rosabrook extends StatefulWidget {
  rosabrook({
    Key? key,
  ...
  @override
  State<rosabrook> createState() {
    return _rosabrookState();
  }
}

class _rosabrookState extends State<rosabrook> {
  @override
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://ragt.nz/product/rosabrook/');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://ragt.nz/wp-content/uploads/2017/03/Rosabrook-subterranean-clover_product-sheet.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
