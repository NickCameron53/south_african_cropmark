...
class RosabrookScreen extends StatefulWidget {
  const RosabrookScreen({
    Key? key,
  ...
  @override
  State<RosabrookScreen> createState() => _RosabrookScreenState();
}

class _RosabrookScreenState extends State<RosabrookScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Rosabrook'),
                  ...
                  Column(
                    ...
                    children: [
                      GlobalWidgets.buildBulletPoint(
                          'A late flowering, black seeded cultivar suited to areas where the season will continue to mid-late November.'),
                      GlobalWidgets.buildBulletPoint(
                          'Is adapted to moderately acid to neutral soils.'),
                      GlobalWidgets.buildBulletPoint(
                          'Has improved resistance to phytophthora and kabatiella fungi.'),
                    ],
                  ),
                  ...
                  const SizedBox(height: 20),
                  GlobalWidgets.buildInfoRow('Seasonal Maturity', 'Late season'),
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow(
                      'Minimal Annual Rainfall', '650 mls'),
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow(
