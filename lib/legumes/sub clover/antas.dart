...
class antas extends StatefulWidget {
  antas({
    Key? key,
  ...
  @override
  State<antas> createState() {
    return _antasState();
  }
}

class _antasState extends State<antas> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Belongs to the sub species Brachycalycinum, and is a black seeded sub clover with a high level of hard seed."
                            "\n\u25BA Is a high yielding, mid to late season maturing cultivar with excellent herbage production which is suited to a wide range of soil types but grows best at a higher pH in more free draining soils."
                            "\n\u25BA Moderate resistance to pythium and fusarium. "
                            "\n\u25BA Antas demonstrates a prostrate to semi erect growth habit.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://barenbrug.com.au/forage-pasture/clover-pasture-legumes/sub-clover/antas.htm');
                                },
