...
class rouse extends StatefulWidget {
  rouse({
    Key? key,
  ...
  @override
  State<rouse> createState() {
    return _rouseState();
  }
}

class _rouseState extends State<rouse> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA A mid to late flowering cultivar of the waterlogging-tolerant ‘white-seeded’ yanninicum sub-species of sub clover."
                            "\n\u25BA It is suited to soils prone to waterlogging or higher annual rainfall and where the growing season extends to mid-late November."
                            "\n\u25BA It is resistant to many clover diseases."
                            "\n\u25BA Moderate levels of hard seededness helps to protect against seedling losses with false breaks.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL('https://ragt.nz/product/rouse/');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://ragt.nz/wp-content/uploads/2017/10/Rouse-subterranean-clover_product-sheet.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
