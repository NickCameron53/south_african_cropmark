...
class woogenellup extends StatefulWidget {
  woogenellup({
    Key? key,
  ...
  @override
  State<woogenellup> createState() {
    return _woogenellupState();
  }
}

class _woogenellupState extends State<woogenellup> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('Black seeded with low levels of hard seed.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://synergyseeds.com.au/variety/woogenellup/');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://synergyseeds.com.au/wp-content/uploads/2022/05/Woogenellup-Sub-Clover-Tech-Sheet-International-Synergy-Seeds-1.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
