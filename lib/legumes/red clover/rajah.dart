...
class rajah extends StatefulWidget {
  rajah({
    Key? key,
  ...
  @override
  State<rajah> createState() {
    return _rajahState();
  }
}

class _rajahState extends State<rajah> {
  @override
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            ...
                            "\n\u25BA Low in oestrogen levels and tolerant to hard grazing.",
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://swseedco.com.au/app/uploads/2023/04/Rajah.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
