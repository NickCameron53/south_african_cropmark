...
class reaper extends StatefulWidget {
  reaper({
    Key? key,
  ...
  @override
  State<reaper> createState() {
    return _reaperState();
  }
}

class _reaperState extends State<reaper> {
  @override
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.cropmarkseeds.com/wp-content/uploads/2024/06/Reaper_TS.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
