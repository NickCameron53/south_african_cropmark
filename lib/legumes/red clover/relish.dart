...
class relish extends StatefulWidget {
  relish({
    Key? key,
  ...
  @override
  State<relish> createState() {
    return _relishState();
  }
}

class _relishState extends State<relish> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text('A more persistent, semi-prostrate growth habit.',
                            style:
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/legumes/red-clover/relish');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Relish-Agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
