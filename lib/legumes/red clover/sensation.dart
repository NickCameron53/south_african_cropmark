...
class sensation extends StatefulWidget {
  ...
  @override
  State<sensation> createState() {
    return _sensationState();
  }
}
                    ...
                    child: Column(
                      children: [
                        SizedBox(
                          ...
                          child: Text('Grasslands Sensation',
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.agricom.co.nz/products/legumes/red-clover/sensation');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.agricom.co.nz/Files/Files/Public/Agricom/Agrinote/Sensation-Agrinote.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
