...
class amigain extends StatefulWidget {
  amigain({
    Key? key,
  ...
  @override
  State<amigain> createState() {
    return _amigainState();
  }
}

class _amigainState extends State<amigain> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            "\u25BA Semi-prostrate growth habit to enhance persistence, suitable for driving animal production, root weevil tolerance, New Zealand bred.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.dlfseeds.com.au/products/legumes/red-clover/amigain');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://www.dlfseeds.com.au/Files/Files/Public/DLFSeedsAU/ProductDownload/2021_Amigain%20Tech%20Sheet.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
