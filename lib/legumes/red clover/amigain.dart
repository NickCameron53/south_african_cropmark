...
class AmigainScreen extends StatefulWidget {
  const AmigainScreen({
    Key? key,
  ...
  @override
  State<AmigainScreen> createState() => _AmigainScreenState();
}

class _AmigainScreenState extends State<AmigainScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Grasslands Amigain'),
