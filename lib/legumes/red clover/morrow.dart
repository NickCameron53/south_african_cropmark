...
class MorrowScreen extends StatefulWidget {
  const MorrowScreen({
    Key? key,
  ...
  @override
  State<MorrowScreen> createState() => _MorrowScreenState();
}

class _MorrowScreenState extends State<MorrowScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Morrow'),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Flowering Date', 'Very Early to Early'),
                  const SizedBox(height: 10),
