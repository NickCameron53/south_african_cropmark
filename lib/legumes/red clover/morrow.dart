...
class morrow extends StatefulWidget {
  morrow({
    Key? key,
  ...
  @override
  State<morrow> createState() {
    return _morrowState();
  }
}

class _morrowState extends State<morrow> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            "\u25BA High yield with improved persistence under grazing. "
                            "\n\u25BA Morrow exhibits improved grazing tolerance due to its more prostrate nature and multi-stemmed plant-type."
                            "\n\u25BA Good late spring and summer finishing feed."
                            "\n\u25BA Morrow is rated as medium for Phyto-oestrogen levels. Care needs to be taken to avoid grazing when mating ewes or hoggets, 3–6 weeks either side of mating.",
                        ...
                        Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  launchURL(
                                      'https://www.barenbrug.co.nz/dairy/cultivars/clover/red-clover');
                                },
                          ...
                          child: Column(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () {
                                    launchURL(
                                        'https://barenbrug.com.au/files/4/5/6/7/3/Barenbrug%20Morrow%20red%20clover%20Tech%20Sheet%202021%20web.pdf');
                                  },
                                  child: Container(
                                    width: 100,
                                    child: Row(
