...
class RossiScreen extends StatefulWidget {
  const RossiScreen({
    Key? key,
  ...
  @override
  State<RossiScreen> createState() => _RossiScreenState();
}

class _RossiScreenState extends State<RossiScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  GlobalWidgets.buildSectionTitle('Rossi\u2122'),
                  ...
                  const SizedBox(height: 10),
                  GlobalWidgets.buildInfoRow('Phyto-oestrogen', 'not stated'),
                  const SizedBox(height: 10),
